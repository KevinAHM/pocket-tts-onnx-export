...
DEFAULT_TEXT_FOR_LANGUAGE = {
    ...
    "french": (
        ...
        "J'espere que vous m'aimerez."
    ),
    "german": (
        "Hallo Welt. Ich bin Kyutais Pocket TTS. "
        "Ich bin schnell genug, um auf kleinen CPUs zu laufen. "
        "Ich hoffe, du wirst mich mogen."
    ),
    "portuguese": (
        "Ola mundo. Eu sou o Pocket TTS da Kyutai. "
        "Sou rapido o suficiente para rodar em CPUs pequenas. "
        "Espero que voce goste de mim."
    ),
    "italian": (
        "Ciao mondo. Sono il Pocket TTS di Kyutai. "
        "Sono abbastanza veloce da funzionare su piccole CPU. "
        "Spero che ti piacero."
    ),
    "spanish": (
        "Hola mundo. Soy el Pocket TTS de Kyutai. "
        "Soy lo suficientemente rapido para funcionar en pequenas CPU. "
        "Espero que te guste."
    ),
}
